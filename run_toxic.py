...
from src.toxic import glue_output_modes as output_modes
from src.toxic import glue_processors as processors
...
MODEL_CLASSES = {
    ...
    "roberta-debias": (RobertaConfig, RobertaForDebiasSequenceClassification, RobertaTokenizer),
...
def load_bias(args):
    ...
    bias_src = args.data_dir+'/'+ args.bias_model
    if not os.path.exists(bias_src):
        logging.info("Bias Model Do Not Exist" % bias_src)
